...
public interface IZegoVideoSDKProxy {
    ...
    void sendCustomVideoCaptureRawData(ByteBuffer data, int dataLength, ZegoVideoFrameParam params);

    void setRoomExtraInfo(String roomID, String key, String value, IRTCCommonCallback callback);

    void sendCustomCommand(String roomID, String command, ArrayList<ZegoUser> toUserList, IZegoIMSendCustomCommandCallback callback);
    ...
    void sendCustomAudioCaptureData(ByteBuffer data, int dataLength, ZegoAudioFrameParam param);

    void setCustomVideoCaptureHandler(IZegoVideoCaptureCallback listener);
    ...
    void setPublisherQualityUpdateCallback(IPublisherQualityUpdateCallback publisherQualityUpdateCallback);
}
