package im.zego.gomovie.server.utils;
...
public class PermissionHelper {
    ...
    public static void onReadWriteSDCardPermissionGranted(FragmentActivity activity, GrantResult grantResult) {
        onPermissionGranted(activity, new String[]{"android.permission.RECORD_AUDIO","android.permission.WRITE_EXTERNAL_STORAGE","android.permission.READ_EXTERNAL_STORAGE"}, grantResult);
    }
